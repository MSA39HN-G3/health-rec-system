...
def _svc(app, **overrides):
    """Tạo service với mock repo (mặc định), đồng bộ với app context."""
    patient_repo = overrides.get("patient_repo", MagicMock())
...
class TestCountPatients:
    def test_count_patients_returns_total(self, app):
    ...
    def test_count_patients_zero(self, app):
...
class TestListPatients:
    def test_calls_paginate(self, app):
    ...
    def test_list_patients_empty(self, app):
...
class TestGetPatient:
    def test_get_patient_found(self, app):
    ...
    def test_get_patient_not_found(self, app):
...
class TestCreatePatient:
    def test_create_patient_minimal(self, app):
    ...
    def test_create_patient_full_info(self, app):
    ...
    def test_create_patient_invalid_date_format(self, app):
...
class TestUpdatePatient:
    def test_update_patient_partial(self, app):
    ...
    def test_update_patient_not_found(self, app):
    ...
    def test_update_patient_invalid_date(self, app):
    ...
    def test_update_patient_all_fields(self, app):
    ...
    def test_update_patient_only_phone(self, app):
    ...
    def test_update_patient_date_to_none(self, app):
...
class TestParseDate:
    def test_parse_date_valid_iso_string(self, app):
    ...
    def test_parse_date_none(self, app):
        """Test _parse_date với None."""
        svc, _ = _svc(app)
        result = svc._parse_date(None)
        assert result is None

    def test_parse_date_invalid_string_format(self, app):
    ...
    def test_parse_date_invalid_type(self, app):
    ...
    def test_parse_date_empty_string(self, app):
    ...
    def test_parse_date_leap_year(self, app):
    ...
    def test_parse_date_invalid_day(self, app):
...
class TestCreatePatientVariations:
    def test_create_patient_with_date_only(self, app):
    ...
    def test_create_patient_with_email_only(self, app):
    ...
    def test_create_patient_with_address_only(self, app):
...
class TestListPatientsVariations:
    def test_list_patients_page_2(self, app):
    ...
    def test_list_patients_large_size(self, app):
    ...
    def test_list_patients_single_item(self, app):
...
class TestCountPatientsVariations:
    def test_count_patients_large_number(self, app):
    ...
    def test_count_patients_one(self, app):
